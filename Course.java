	...
	//represents each course
		...
		public void createStudentGroups(){
			...
			while(subjectIterator.hasNext()){
				...
				StudentGroups studentGroup=new StudentGroups(this.courseName+"/"+subject.getSubjectName(), subject.getnumberOfExamsPerDay(), size, combs, subject.getSubjectName(), subject.isIslab(), subject.getDepartment());
			    studentGroups.add(studentGroup);
			    size=0;
			}
		}
		
		//creates all possible invigilator x subject  assigns combinations and saves as exam objects
